...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_stash__ = __webpack_require__(72);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('h2', {
    ...
    attrs: {
      "role": _vm.modifyRole,
      "permissions": _vm.$store.permissions
    },
    on: {
  ...
  }) : _vm._e()], 1), _vm._v(" "), (_vm.$store.roles) ? _c('table', {
    staticClass: "table"
  }, [_vm._m(0), _vm._v(" "), _c('tbody', _vm._l((_vm.$store.roles), function(role) {
...
var _storeAccessor = __webpack_require__(73);
